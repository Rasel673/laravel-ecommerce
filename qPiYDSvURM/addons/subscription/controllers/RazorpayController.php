...
class RazorpayController extends Controller
{
    public function payWithRazorpay($request)
    {
        if(Session::has('payment_type')){
            ...
            elseif (Session::get('payment_type') == 'wallet_payment' || Session::get('payment_type') == 'subscription') {
    ...
    public function payment()
    {
        ...
        if(Session::get('payment_type') == 'cart_payment' || Session::get('payment_type') == 'wallet_payment' || Session::get('payment_type') == 'subscription'){
        ...
        if(count($input)  && !empty($input['razorpay_payment_id'])) {
            ...
            if(Session::has('payment_type')){
                ...
                elseif (Session::get('payment_type') == 'subscription') {
                    ...
                    return $subscriptions->payment_done(Session::get('payment_data'), $payment_detalis);
                }
            }
        }
    }
